...
public class TourMapper {
    ...
    public TourDTO toDTO(Tour tour) {
        ...
        dto.setDeliveryIds(tour.getDeliveries() != null ?
                tour.getDeliveries().stream().map(Customer::getId).collect(Collectors.toList()) : null);
        return dto;
    }

    public Tour toEntity(TourDTO dto, Vehicle vehicle, Warehouse warehouse, java.util.List<Customer> deliveries) {

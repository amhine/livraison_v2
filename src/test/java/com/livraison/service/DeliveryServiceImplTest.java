...
class DeliveryServiceImplTest {
    ...
    void setup() {
        ...
        deliveryMapper = new DeliveryMapper() {
            @Override public DeliveryDTO toDTO(Customer d) {
            ...
            @Override public Customer toEntity(DeliveryDTO dto) {
    ...
    void createDelivery_withTour_setsRelation() {
        ...
        when(deliveryRepository.save(any(Customer.class))).thenAnswer(inv -> inv.getArgument(0));
